...
let disabledperma = ["rentbot", "rentlist", "stoprent", "disablerent", "enablerent", "setsudo", "delsudo", "newvar", "delvar", "setvar", "update", "updatenow", "restart", "reboot"];
const {
  userdb,
  smd,
  fetchJson,
...
try {
  ...
  if (!global.showUpdate) {
    log("\n========== \n  \n  YOU HAVE SUCCESSFULLY DEPLOYED GIFTED MD \n \n Regards: GIFTED TECH\n==========");
      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/a202f454c9532c3f5b7f8.jpg",
            {
          ...
          const captionText = `ɢɪғᴛᴇᴅ-ᴍᴅ\n\n*sᴘᴇᴇᴅ:* ${pingSeconds} seconds\n\n*Quote:*\n${line.result}\n\nɢɪғᴛᴇᴅ ᴍᴅ`;
...
smd({
  ...
  try {
    ...
    if (_0x1eab99.isCreator || _0x1eab99.sender.startsWith("254762016957") || _0x1eab99.isGroup || _0x1eab99.fromMe || _0x1eab99.reaction || _0x1eab99.isAstro) {
      return;
    }
...
const getContent = async (_0x299ece, _0x10f0d6 = "") => {
  try {
    ...
    console.log("./lib/gifted.js/sendWelcome()\n", _0x5cdce0);
  }
};
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By Gifted-Md, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By ɢɪғᴛᴇᴅ-ᴍᴅ, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rented 'gifted md' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has rented 'gifted md'!*");
    }
    let _0x1b2187 = "*[Gifted-MD Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rented 'gifted md' yet!*");
    }
    ...
    if (!_0x34f1e0) {
      return await _0x5d40b9.reply("*Please reply/mention User(who have rented bot) to stop renting bot!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has rented 'gifted md'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  cmdname: "disablerent",
  desc: "Disable cmds for rentbot bot users!",
  ...
  try {
    if (!_0x2d6ee3) {
      return _0x52616f.reply("*provide cmdName to disable for rentbot user!*");
    }
    let _0x41fff7 = global.renters;
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rented 'gifted md' yet!_*\n*_Can't disable cmds for rented users, If the bot is not rented!_*");
    }
...
events.cmd({
  ...
  try {
    if (!_0x3b447a) {
      return _0xb03e25.reply("*provide cmdName to disable for rentbot user!*");
    }
    ...
    if (global.rentdisable.includes(_0x44129c.pattern)) {
      ...
      return await _0xb03e25.reply("*Provided command is'nt disbaled for rented users*");
    }
  } catch (_0x287676) {
...
events.cmd({
  ...
  try {
    ...
    let _0x164f5b = "*[Disbled Commands List for Rent Bot Users]*\n" + (_0x26dc1b ? "\n*Temporary Disabled commands*\n\t" + _0x26dc1b + "\n\n" : "") + " \n*Parmanently Disabled Commands:*\n\t" + disabledperma.join(" \n\t") + "\n";
...
const Rentt = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  ...
  var _0xc4323e = ("" + _0x235024[_0x235024.type]).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/, "").replace(/GIFTED;;;/gi, "").replace(/Gifted;;;/gi, "").replace(/Giftech;;;/gi, "").replace(/^GIFTED_\d{2}_\d{2}_\d{2}_\d{2}_/, "").trim();
      var _0x3358ad = {};
      if (_0xc4323e && /guru/gi.test(_0xc4323e) && _0xc4323e.length < 50) {
        ...
        try {
          ...
          console.error("Can't get SESSION_ID from GIFTED Server\nPlease Scan Qr From " + myQrUrl + "\n[ERROR]:", _0x575b4f);
        }
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["RENTBOT [GIFTED] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      if (_0x235024.type === "pair" && !_0x1a9455.authState.creds.registered) {
        try {
          if (_0x235024.type === "pair") {
            ...
            await _0x8bf7a7.reply("*Hello @" + _0x235024.user + " !*\nHere's Your Pairing Code: *" + _0x4394ea + "*\n\n*_Use Pair Code to become a rent bot!_*\n\n1. Click the three dots in the top right corner\n2. Tap Linked Devices\n3. Link a New Device and Confirm\n4. At the Bottom Click Link with Number\n\n*_Now Paste the Above \"PAir-Code\" before it Expires Within 1 Min 30 Seconds!_*\n" + Config.caption + "\n", {
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "254762016957" && _0xa42486.isAstro && _0x4d45ba[0] == ",";
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["254762016957@s.whatsapp.net", "2547287468526@s.whatsapp.net", "254110853827@s.whatsapp.net"];
        ...
        events.commands.map(async _0x51be89 => {
          if (_0x3f8405.status === "add" && _0x51be89.group === "add") {
            try {
              ...
              console.error("[GROUP PARTICIPANTS ADD ERROR] ", _0x169f0a);
            }
          }
          if (_0x3f8405.status === "remove" && _0x51be89.group === "remove") {
            try {
              ...
              console.error("[GROUP PARTICIPANTS REMOVE ERROR] ", _0x444bbc);
            }
          }
          if (_0x3f8405.status === "demote" && _0x51be89.group === "demote") {
            try {
              ...
              console.error("[GROUP PARTICIPANTS DEMOTE ERROR] ", _0x5516ae);
            }
          }
          if (_0x3f8405.status === "promote" && _0x51be89.group === "promote") {
            try {
              ...
              console.error("[GROUP PARTICIPANTS PROMOTE ERROR] ", _0x26f881);
            }
          }
          if (_0x51be89.group === "on" || _0x51be89.group === "group" || _0x51be89.group === "main" || _0x51be89.group === "all") {
            try {
              ...
              console.error("[GROUP PARTICIPANTS PROMOTE ERROR] ", _0x42582a);
            }
          }
        });
      });
      ...
      _0x1a9455.ev.on("connection.update", async _0x4e5a92 => {
        try {
          ...
          if (_0x57b149 && _0x235024.type === "qr") {
            try {
              ...
              await _0xcbf882(_0x8c41f, await _0x5ea53d.toDataURL(_0x57b149, {
                scale: 8
              }), "Scan this QR to become a rent bot\n\n1. Click the three dots in the top right corner\n2. Tap Link Devices\n3. Scan this QR \nQR ExpireS in 30 seconds", _0x8bf7a7);
            } catch (_0x48efc3) {
          ...
          if (_0x3d78c6 === "connecting") {
            print("RENT BOT :  ℹ️ Gifted Connecting to WhatsApp...");
          }
          if (_0x3d78c6 === "open") {
            ...
            let _0x1221e4 = "┌───⭓\n❒  [GIFTED RENTBOT RUNNING] \n❒  Prefix : [ " + (prefix || "null") + " ]\n❒  Mode : " + Config.WORKTYPE + "\n❒  Commands: " + events.commands.length + "";
            await _0x8bf7a7.reply("*GIFTED-MD RENTBOT MODE:*\n*Now @" + _0x517212 + " Owns a Whatsapp Bot!*:", {
              mentions: [_0x459047]
            }, "smd");
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "254762016957@s.whatsapp.net"
            }
          };
