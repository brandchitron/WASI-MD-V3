let {
 ...
 smd({
   ...
   try {
     if (!_0x45bf7a) {
       return _0x3b2ef2.reply("Example : " + prefix + "request [REQUEST/BUG] logo commands are not working!");
     }
     ...
     await _0x3b2ef2.sendMessage("254762016957@s.whatsapp.net", {
 ...
 smd({
   ...
   try {
     ...
     for (let _0x12e4c4 of _0x1fd73d.participants) {
       let _0x2f7779 = /2348039607375|2349027862116/g.test(_0x12e4c4.id) ? "Gifted Tech" : "" + _0x12e4c4.id.split("@")[0];
 ...
 }); // POWERED BY GIFTED-MD, MADE WITH ❤️
