...
smd(
   ...
   async (_0x514d3c) => {
     ...
     _0x514d3c.reply("Gifted Md is Shutting Down...");
...
smd({
  ...
  _0x514d3c.reply("Gifted Md is Restarting...");
...
smd({
  ...
  try {
    ...
    return await _0x2a10d6.send(!_0x4e5e2e ? "*_There's no plugin installed in " + Config.botname + "_*" : !_0x2420b0 ? "*All Installed Modules are:-*\n\n" + _0x4e5e2e : _0x4e5e2e);
  } catch (_0x21e335) {
