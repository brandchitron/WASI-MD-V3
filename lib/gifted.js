...
yt.getInfo = async (_0x3c2895, _0x49e43c = {}) => {
  try {
    ...
    console.log("./lib/gifted/yt.getInfo()\n", _0x39b819.message);
    return {
      status: false
    };
  }
...
yt.download = async (_0x1ea0cb, _0x5c75ae = {
  ...
  try {
    ...
    console.log("./lib/gifted/yt.dowanload()\n", _0x26244e.message);
    return false;
  }
};
async function sendAnimeReaction(_0x5c448a, _0x46face = "punch", _0x50961f = "", _0x426154 = "") {
  try {
    ...
    return await _0x5c448a.error(_0x1b7c90 + "\nERROR AT : /lib/gifted.js/sendAnimeReaction()\n\ncommand: " + _0x46face);
  }
}
async function sendGImages(_0x4a189d, _0x4eee7c, _0x205b7c = caption, _0x1caf0d = "") {
  try {
    ...
    return console.log("./lib/gifted.js/sendGImages()\n", _0x36d8e7);
  }
}
async function AudioToBlackVideo(_0x2bac4d, _0x568b06) {
  try {
    ...
    console.error("./lib/gifted.js/AudioToBlackVideo()\n", _0x4971e7);
    return {
      result: false
    };
  }
      ...
      if (_0x76cd91 === "all") {
        ...
        for (const _0x1b15fa in _0x188cac) {
          try {
            ...
            console.log("❌ " + _0x1b15fa + " ❌ CANNOT BE REMOVED", _0x5b48c7);
          }
        }
        await bot_.updateOne({
          id: "bot_" + _0x2e788f.user
...
async function randomeFunfacts(_0x1be35e) {
  try {
    if (_0x1be35e === "question") {
      ...
      return "╔════◇\n║ *🎗️Quote:* " + _0x6d4253.quote.body + "\n║ *👤Author:* " + _0x6d4253.quote.author + "\n║\n╚════════════╝";
    }
  } catch (_0x1147af) {
    msg.error(_0x1147af);
    console.log("./lib/gifted.js/randomeFunfacts()\n", _0x1147af);
  }
}
async function audioEditor(_0x1ef339, _0x567a0f = "bass", _0x730356 = "") {
  ...
  try {
    ...
    return console.log("./lib/gifted.js/audioEditor()\n", _0x48606a);
  }
}
async function send(_0x38fbe8, _0x3e1faf, _0x38564b = {
  ...
  try {
    ...
    console.log("./lib/gifted.js/send()\n", _0x164757);
  }
}
async function react(_0x460a9b, _0x131f21, _0x1b76d0 = "") {
  try {
    ...
    console.log("./lib/gifted.js/react()\n", _0x102c7a);
  }
}
let note = {
...
async function sendWelcome(_0x50ffa3, _0x3417a5 = "", _0x27d774 = "", _0x3fa550 = "", _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    if (_0x3417a5) {
      ...
      let _0x23df3f = _0x3417a5.replace(/@user|&user/gi, "@" + _0x50ffa3.senderNum).replace(/@name|&name/gi, _0x50ffa3.senderName || "_").replace(/@gname|&gname/gi, "").replace(/@desc|&desc/gi, "").replace(/@count|&count/gi, "1").replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, "").replace(/@time|&time/gi, _0x50ffa3.time).replace(/@date|&date/gi, _0x50ffa3.date).replace(/@bot|&bot/gi, "" + Config.botname).replace(/@owner|&owner/gi, "" + Config.ownername).replace(/@caption|&caption/gi, caption).replace(/@gurl|@website|&gurl|&website|@link|&link/gi, gurl).replace(/@myyt|&myyt/gi, "https://github/mouricedevs").replace(/@telegram|&telegram/gi, global.telegram || "https://t.me/giftedmd").replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || "https://github/mouricedevs").replace(/@runtime|&runtime|@uptime|&uptime/gi, "" + runtime(process.uptime())).trim();
      try {
  ...
  try {
    ...
    if (_0x2b48e0 && _0x2b48e0.includes(":")) {
      ...
      if (_0x2d4089.toLowerCase() === "richel" || _0x2d4089 === "1") {
        ...
        _0x30713a = 34;
      } else if (_0x2d4089.toLowerCase() === "gifted" || _0x2d4089 === "36") {
        _0x30713a = 35;
...
setMention.get = async _0x2cdc1a => {
  try {
    ...
    if (_0x584f1d.get) {
      ...
      return await _0x2cdc1a.reply("*You did'nt set mention message yet!*\n*please Check: https://github.com/mouricedevs/Gifted-Md/wiki/mention*");
    }
  } catch (_0x4535a8) {
